...
class CreateSaleItemDTO
{
    public function __construct(
        ...
        public readonly float $product_discount,
        public readonly float $product_discount_value,
    ...
    public static function fromRequest($data): self
    {
        return new self(
            ...
            product_discount_value: $data['productDiscountValue'],
    ...
    public function toArray(): array
    {
        return [
            ...
            'product_discount_value' => $this->product_discount_value,
