...
namespace App\Http\Requests\Subscription\Payment\CreditCard;

use App\Rules\CpfCnpj;
use Carbon\Carbon;
use Illuminate\Foundation\Http\FormRequest;

class CreatePaymentCreditCardRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'creditCardHolderInfo.cpfCnpj' => ['required', 'string', 'regex:/^\d{11}$|^\d{14}$/', new CpfCnpj],
