...
class ExportDeliveryRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'format.required' => 'O formato deve ser informado.',
            'format.string' => 'O formato deve ser um texto válido.',
            'format.in' => 'O formato deve ser pdf.',
        ];
    }
}
