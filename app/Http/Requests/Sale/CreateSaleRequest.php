...
class CreateSaleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'clientData.name' => 'nullable|string|mimn:1|max:100',
            ...
            // REGRAS DA VENDA
            'dataSale.totalPrice' => 'required|numeric',
            ...
            'freightValue' => 'required|numeric|min:0',
            ...
            'recipientName' => 'nullable|string|min:3|max:100',
            'recipientPhone' => 'nullable|string|max:20',
    ...
    public function messages(): array
    {
        return [
            ...
            // Venda
            'dataSale.totalPrice.required' => 'O valor total da venda é obrigatório.',
            'dataSale.totalPrice.numeric' => 'O valor total da venda deve ser numérico.',
            'dataSale.products.required' => 'É necessário enviar pelo menos um produto.',
            'dataSale.products.array' => 'Os produtos devem ser um array.',
            'dataSale.products.*.product_variant_id.required' => 'O ID da variante do produto é obrigatório.',
            'dataSale.products.*.product_variant_id.exists' => 'O produto selecionado não existe.',
            'dataSale.products.*.newQuantity.required' => 'A quantidade do produto é obrigatória.',
            'dataSale.products.*.newQuantity.min' => 'A quantidade do produto deve ser no mínimo 1.',
            'dataSale.products.*.stock_quantity.required' => 'A quantidade em estoque é obrigatória.',
            'dataSale.products.*.stock_quantity.min' => 'A quantidade em estoque deve ser no mínimo 1.',
            ...
            'freightValue.required' => 'O valor do frete é obrigatório.',
            'freightValue.numeric' => 'O valor do frete deve ser numérico.',
            'freightValue.min' => 'O valor do frete não pode ser negativo.',
            ...
            'numberAddress.numeric' => 'O número do endereço deve ser numérico.',
            'complement.max' => 'O complemento não pode exceder 100 caracteres.',
            'recipientName.min' => 'O nome do recebedor deve ter pelo menos 3 caracteres.',
            'recipientName.max' => 'O nome do recebedor não pode exceder 100 caracteres.',
            'recipientPhone.max' => 'O telefone do recebedor não pode exceder 20 caracteres.',
