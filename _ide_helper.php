...
namespace Spatie\Prometheus\Facades {
    ...
    class Prometheus
    {
         ...
         * @static
         */
        public static function registerCollectorClasses($collectors, $constructorParameters = [])
        {
            /** @var \Spatie\Prometheus\Prometheus $instance */
            return $instance->registerCollectorClasses($collectors, $constructorParameters);
        }
